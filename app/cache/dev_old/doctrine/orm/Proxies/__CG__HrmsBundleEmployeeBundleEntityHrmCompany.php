...
class HrmCompany extends \Hrms\Bundle\EmployeeBundle\Entity\HrmCompany implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'idCompany', 'idAdmin', 'companyName', 'companyInfo', 'displayname', 'emailId', 'password', 'rePassword', 'role', 'address', 'taxId', 'twitterId', 'facebookId', 'linkedinId', 'logo', 'language', 'currency', 'timezone', 'addDate', 'lastLogin', 'isactive', 'ip', 'id');
    }

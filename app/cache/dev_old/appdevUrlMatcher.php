...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/js/f07a403')) {
            ...
            if (0 === strpos($pathinfo, '/js/f07a403_part_1_bootstrap')) {
                // _assetic_f07a403_0
                if ($pathinfo === '/js/f07a403_part_1_bootstrap_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'f07a403',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_f07a403_0',);
                }

                // _assetic_f07a403_1
                if ($pathinfo === '/js/f07a403_part_1_bootstrap.min_2.js') {

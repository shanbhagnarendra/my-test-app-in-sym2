...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/Symfony/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'HrmsEmployeeBundle', 'C:/xampp/htdocs/Symfony/app/Resources/HrmsEmployeeBundle/views', '/\\.[^.]+\\.php$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'HrmsEmployeeBundle', 'C:\\xampp\\htdocs\\Symfony\\src\\Hrms\\Bundle\\EmployeeBundle/Resources/views', '/\\.[^.]+\\.php$/'))), 'php');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'HrmsEmployeeBundle', 'C:/xampp/htdocs/Symfony/app/Resources/HrmsEmployeeBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'HrmsEmployeeBundle', 'C:\\xampp\\htdocs\\Symfony\\src\\Hrms\\Bundle\\EmployeeBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/xampp/htdocs/Symfony/app/Resources/views', '/\\.[^.]+\\.php$/'), 'php');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/xampp/htdocs/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager5245706da8513_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5245706da8513_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/xampp/htdocs/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_5245706da8513.php';
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\xampp\\htdocs\\Symfony\\src\\Hrms\\Bundle\\EmployeeBundle\\Resources\\config\\doctrine' => 'Hrms\\Bundle\\EmployeeBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Hrms\\Bundle\\EmployeeBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('HrmsEmployeeBundle' => 'Hrms\\Bundle\\EmployeeBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5245706da8513_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '6950996336c155bc69b6ba61cd3b329b213d25ee');
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'C:/xampp/htdocs/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'HrmsEmployeeBundle'), $this->get('assetic.value_supplier.default')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Symfony\\src\\Hrms\\Bundle\\EmployeeBundle/Resources/views', 'HrmsEmployee');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6950996336c155bc69b6ba61cd3b329b213d25ee');
    }
     ...
     *
     * @return EntityManager5245706da8513_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HrmsEmployeeBundle' => 'Hrms\\Bundle\\EmployeeBundle\\HrmsEmployeeBundle',
            ...
            'locale' => 'en',
            'secret' => '6950996336c155bc69b6ba61cd3b329b213d25ee',
            'database_path' => NULL,
            ...
            'kernel.secret' => '6950996336c155bc69b6ba61cd3b329b213d25ee',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_5245706da8513.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5245706da8513_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',

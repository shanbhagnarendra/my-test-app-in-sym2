 ...
 */
class HrmCountry extends \Hrms\Bundle\EmployeeBundle\Entity\HrmCountry implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdCountry()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["idCountry"];
        }
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'countryName', 'countryCode', 'idCountry');
    }

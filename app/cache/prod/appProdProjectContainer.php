...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/Symfony/app/cache/prod/assetic/config');
    ...
    {
        require_once 'C:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_5244028114952.php';
        ...
        $f->setProxyDir('C:/xampp/htdocs/Symfony/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5244028114952_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Symfony/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'C:/xampp/htdocs/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Symfony/app/cache/prod/profiler',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_5244028114952.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5244028114952_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
